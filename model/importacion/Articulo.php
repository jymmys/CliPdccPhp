...
<?php class Articulo
{
    ...
    /**
     * Get the value of numeroLicenciaPrevia
     */

    public function getNumeroLicenciaPrevia()
    {
        return $this->numeroLicenciaPrevia;
    }

    /**
     * Set the value of numeroLicenciaPrevia
     *
     * @return  self
     */

    public function setNumeroLicenciaPrevia($numeroLicenciaPrevia)
    {
