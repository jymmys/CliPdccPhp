...
public class Articulo {
	...
	private String numeroLicenciaPrevia;
	...
	public Articulo(String numero, String codigoArancelario, String especificaciones, String tipouso, String pais,
			String condicionArticulo, String numeroDocumento, String numeroLicenciaPrevia, double cantidadUnidades,
		...
		this.numeroLicenciaPrevia = numeroLicenciaPrevia;
	...
	/**
	 * @return the numeroLicenciaPrevia
	 */
	public String getNumeroLicenciaPrevia() {
		return numeroLicenciaPrevia;
	}
	/**
	 * @param numeroLicenciaPrevia the numeroLicenciaPrevia to set
	 */
	public void setNumeroLicenciaPrevia(String numeroLicenciaPrevia) {
		this.numeroLicenciaPrevia = numeroLicenciaPrevia;
	}
	/**
